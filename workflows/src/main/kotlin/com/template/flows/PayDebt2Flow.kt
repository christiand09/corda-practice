...
//@InitiatingFlow
//@StartableByRPC
//class PayDebt2Flow(val linearId: UniqueIdentifier, val amount: Amount<Currency>): FlowLogic<SignedTransaction>() {
//    @Suspendable
//    override fun call(): SignedTransaction {
//        // Step 1. Retrieve the IOU state from the vault.
//        val queryCriteria = QueryCriteria.LinearStateQueryCriteria(linearId = listOf(linearId))
//        val iouToSettle = serviceHub.vaultService.queryBy<MyState>(queryCriteria).states.single()
//        val counterparty = iouToSettle.state.data.receiver
//
//        // Step 2. Check the party running this flow is the borrower.
//        if (ourIdentity != iouToSettle.state.data.sender) {
...
//        val settleCommand = Command(MyContract.Commands.Issue(), listOf(counterparty.owningKey, ourIdentity.owningKey))
...
//        val amountRemaining = iouToSettle.state.data.cash - iouToSettle.state.data.paid - amount
...
// */
//@InitiatedBy(PayDebt2Flow::class)
