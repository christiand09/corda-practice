...
class UpdateRegisterFlow (var name: Name, var receiver: String, val linearId: UniqueIdentifier) : FlowLogic<SignedTransaction>(){
    ...
    class UpdateRegisterFlowResponder(val flowSession: FlowSession): FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            val dataTransfered = flowSession.receive(Name::class.java).unwrap { it }
            subFlow(UserFlow(dataTransfered))
