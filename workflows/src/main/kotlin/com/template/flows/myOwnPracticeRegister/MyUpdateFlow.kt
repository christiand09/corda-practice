...
private fun outputState(): MyState{
    ...
    if(registered.contactNumber == "")
        registered.contactNumber = input.registered.contactNumber
...
@InitiatedBy(MyUpdateFlow::class)
class MyUpdateFlowResponder(val flowSession: FlowSession): FlowLogic<SignedTransaction>() {
