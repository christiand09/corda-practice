...
class VerifyFlow (private val linearId: UniqueIdentifier) : FlowLogic<SignedTransaction>()
{
    ...
    override fun call(): SignedTransaction
    {
        ...
        val outputState = RegisterState(input.firstName, input.lastName, input.age, input.gender, input.address,
                input.sender, input.receiver, approved = true, linearId = input.linearId)
        val verifyCommand = Command(RegisterContract.Commands.Verify(), listOf(ourIdentity.owningKey, input.receiver.owningKey))
